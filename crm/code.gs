...
var PLATFORMS = [
  ...
  // сайт продвигается Директом, поэтому заявки с сайта относим к нему:
  // у заведённых вручную заявок utm-меток нет, а считать их надо
  { name: 'Яндекс Директ',
    sources: ['Сайт: быстрая форма', 'Сайт: подбор системы', 'Сайт: галерея объектов',
              'Сайт: звонок', 'Сайт: почта', 'Сайт: MAX', 'Сайт: Telegram'],
    utm: ['yandex', 'yandex_direct', 'direct', 'ya'] },
